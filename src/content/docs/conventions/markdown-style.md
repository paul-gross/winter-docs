...
Agents, skills, and commands follow consistent naming so a prefix maps predictably to an extension (`wf-glacier`, `wg-issue`, `wst-…`). These naming conventions are part of the winter-ecosystem agent-context domain (`agent-context/`).
