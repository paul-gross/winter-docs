...
Full command reference: [`ai/winter-cli/usage.md`](https://github.com/paul-gross/winter/blob/master/ai/winter-cli/usage.md). Raw git equivalents for every operation: [`ai/worktree-ops.md`](https://github.com/paul-gross/winter/blob/master/ai/worktree-ops.md). See also the [CLI Reference](/winter-docs/cli-reference/).
:::
