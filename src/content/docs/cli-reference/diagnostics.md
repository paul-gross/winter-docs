...
Commands for diagnosing workspace health, linting convention compliance, and introspecting the module graph and
capability bindings. These commands are read-only or report-only — they do not modify workspace state.
