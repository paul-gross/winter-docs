...
Related projects enrich the Winter ecosystem but sit in a different category from [extensions](/winter-docs/extensions/)
and [examples](/winter-docs/examples/). Understanding the distinctions:
...
- **[winter-nvim](/winter-docs/related-projects/winter-nvim/)** — Neovim integration for Winter workspaces: a
  fuzzy-finder over feature-environment worktrees, a workspace status dashboard, and a cross-repo diff viewer. It reads
  workspace state from inside Neovim but does not change it.
